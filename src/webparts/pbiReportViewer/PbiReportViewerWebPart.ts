...
export interface IPbiReportViewerWebPartProps {
  workspaceId: string;
  reportId: string;
}

export default class PbiReportViewerWebPart extends BaseClientSideWebPart<IPbiReportViewerWebPartProps> {
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    ...
    return {
      pages: [{
        header: { description: "Power BI Report Viewer Web Part" },
        groups: [{
